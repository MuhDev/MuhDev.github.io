const projectsData = [
    {
        ...
        description: "منصة اجتماعية للفيديوهات القرآنية. يمديك تشاهد، تتفاعل، وتعلق، وحتى ترفع فيديوهاتك.",
    ...
    },
    {
        ...
        description: "تطبيق تعريفي لجمعية خيرية، يعرض مشاريعهم وفيه ميزة رهيبة لتحميل استيكرات الواتساب.",
    ...
    },
    {
        ...
        description: "يسهّل عليك الاستشارات الطبية، يخليك تتواصل مع دكتورك مكالمة صوتية أو فيديو بكل سهولة.",
    ...
    },
    {
        ...
        description: "يوريك المتاجر والمطاعم اللي حولك، ويعطيك خصومات وكاش باك يوفر عليك.",
    ...
    {
        haveDetails: true,
        image: "https://i.ibb.co/q3v532NY/Special-Offers.jpg",
        title: "Special Offers",
        logoUrl: "https://i.ibb.co/6mkk6td/icon-foreground.png",
        description: "تطبيق يجمع لك عروض المتاجر الإلكترونية كلها بمكان واحد، يفكك من حوسة البحث ويوفر وقتك.",
    ...
    {
        haveDetails: false,
        image: "https://i.ibb.co/7JLYMkMw/CoffeApp.jpg",
        title: "Coffee App",
        description: "تطبيق قهوة، حولنا فيه تصميم Dribbble لتطبيق Flutter تفاعلي ورهيب.",
        date: "2021",
        buttons: [
            {
                type: "github",
    ...
    {
        haveDetails: false,
        image: "https://i.ibb.co/mrC2F0F1/World-Cup-App.jpg",
        title: "Qatar World Cup",
        description: "تطبيق لكأس العالم قطر 2022، صممناه كتحدي لإبراز قدرات Flutter في التصميم.",
        date: "2022",
        buttons: [
            {
                type: "github",
    ...
    {
        haveDetails: false,
        image: "https://i.ibb.co/WpsfSZRy/Travel-App.png",
        title: "Travel App",
        description: "تطبيق للسفر، جِبنا تصميم من Dribbble وحولناه لتطبيق Flutter بتجربة مستخدم ناعمة.",
        date: "2022",
        buttons: [
            {
                type: "github",
